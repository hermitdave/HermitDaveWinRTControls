...
namespace HermitDaveControls
{
    public sealed class AutoCompleteTextBlock : Control
    {
        ...
        public static readonly DependencyProperty ItemsSourceProperty = DependencyProperty.Register("ItemsSource", typeof(ICollection<string>), typeof(AutoCompleteTextBlock), new PropertyMetadata(null));
