...
namespace HermitDaveControls
{
    public sealed class ColorHexagonPicker : ColorBaseControl
    {
        ...
        public ColorHexagonPicker()
        {
            ...
            ManipulationStarted += ColorHexagonPicker_ManipulationStarted;
            ManipulationCompleted += ColorHexagonPicker_ManipulationCompleted;
        }

        void ColorHexagonPicker_ManipulationCompleted(object sender, ManipulationCompletedRoutedEventArgs e)
        {
            _fingerMovement = false;
        }

        void ColorHexagonPicker_ManipulationStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
        ...
        private Rectangle CreateRectangle(Color color)
        {
            ...
            rect.Tapped += RectangleTap;

            // handles person moving around
            rect.PointerEntered += RectangleMouseEnter;
        ...
        void RectangleMouseEnter(object sender, PointerRoutedEventArgs e)
        {
        ...
        void RectangleTap(object sender, TappedRoutedEventArgs e)
        {
            SetRectFromEvent(sender);
        }
